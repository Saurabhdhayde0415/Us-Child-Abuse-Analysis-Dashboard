...
Identify states with the highest number of perpetrators.

Compare perpetrator categories such as parents, foster parents, friends & neighbors, legal guidance, and more.

Highlight states with high counts in specific categories like child daycare providers and multiple relationships.

Analyze year-over-year patterns and demographic distribution.
...
1,616 cases from legal guidance roles
...
Created relationships using an optimized data model

Designed KPIs using DAX measures
...
Clear state-wise comparison

KPI summary cards

Funnel, bar, donut, and vertical charts

Actionable insights for decision-makers

Professional dark UI design with consistent color palette
